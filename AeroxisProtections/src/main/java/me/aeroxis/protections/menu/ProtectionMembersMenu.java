...
/**
 * 🛡️ AeroxisProtections - Menú de Acólitos (Arquitectura Enterprise)
 ...
 */
public class ProtectionMembersMenu extends AeroxisMenu {
    ...
    public ProtectionMembersMenu(Player player, ProtectionStone stone, AeroxisProtections plugin,
