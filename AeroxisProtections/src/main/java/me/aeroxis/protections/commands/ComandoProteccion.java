package me.aeroxis.protections.commands;
...
/**
 * 🛡️ AeroxisProtections - Comando Principal (Arquitectura Enterprise)
...
public class ComandoProteccion {
    ...
    @Inject
    public ComandoProteccion(AeroxisProtections plugin, ConfigManager configManager, ClaimManager claimManager, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
