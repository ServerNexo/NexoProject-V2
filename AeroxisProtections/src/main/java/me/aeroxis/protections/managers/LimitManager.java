...
/**
 * 🛡️ AeroxisProtections - Gestor de Límites (Arquitectura Enterprise)
...
public class LimitManager {
    ...
    public int getMaxProtections(UUID playerId) {
        AeroxisUser user = userManager.getUserOrNull(playerId);
        ...
        if (user.hasClan()) {
            ...
            AeroxisClan clan = clanManager.getClanFromCache(user.getClanId()).orElse(null);
            if (clan != null) {
