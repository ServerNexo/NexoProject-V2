package me.aeroxis.protections.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.protections.AeroxisProtections;
import me.aeroxis.protections.config.nodes.ProtectionsMessagesConfig;
...
/**
 * 🛡️ AeroxisProtections - Config Manager Purificado (Arquitectura Enterprise)
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisProtections plugin) {
        this.plugin = plugin;
    ...
    private void loadConfigurate() {
        ...
        try {
            ...
            if (this.messages == null) {
                plugin.getLogger().warning("⚠️ El archivo messages.yml de AeroxisProtections parece estar vacío. Usando valores por defecto.");
                this.messages = new ProtectionsMessagesConfig(); 
            }
        } catch (Exception e) {
            plugin.getLogger().severe("❌ Error crítico al cargar messages.yml en AeroxisProtections: " + e.getMessage());
