package me.aeroxis.factories.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.factories.AeroxisFactories;
import me.aeroxis.factories.config.nodes.FactoriesMessagesConfig;
...
/**
 * 🏭 AeroxisFactories - Gestor de Configuración Tipado (Arquitectura Enterprise Java 21)
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisFactories plugin) {
        this.plugin = plugin;
