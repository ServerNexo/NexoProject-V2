...
import me.aeroxis.war.config.ConfigManager; // 🌟 FIX ERROR IMPORT: Faltaba esta línea
import me.aeroxis.war.core.WarContract;
...
/**
 * ⚔️ AeroxisWar - Gestor Táctico (Arquitectura Enterprise)
...
public class WarManager {
    ...
    @Inject
    public WarManager(AeroxisWar plugin, ConfigManager configManager, UserManager userManager,
    ...
    public void iniciarDesafio(Player leader, AeroxisClan atacante, AeroxisClan defensor, BigDecimal apuesta) {
    ...
    public boolean estanEnGuerraActiva(UUID player1, UUID player2) {
        AeroxisUser u1 = userManager.getUserOrNull(player1);
        AeroxisUser u2 = userManager.getUserOrNull(player2);
