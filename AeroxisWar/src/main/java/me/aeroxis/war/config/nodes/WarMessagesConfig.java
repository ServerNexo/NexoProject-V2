package me.aeroxis.war.config.nodes;
...
/**
 * ⚔️ AeroxisWar - Configurate Type-Safe Node (Arquitectura Enterprise)
 * Mapeo de mensajes tácticos para el módulo de Guerra.
...
public class WarMessagesConfig {
    ...
    public static class AlertasNode {
        // 🌟 FIX: Migración de &c, &e, &7 a Hex/MiniMessage
        @Setting("declaracion-guerra") private List<String> declaracionGuerra = List.of(
                "&#ff00ff&m==================================",
                "&#E6CCFF<bold>¡ALERTA DE GUERRA!</bold>",
                "&#E6CCFFEl clan &#8b0000%atacante% &#E6CCFFha emitido un contrato.",
                "&#E6CCFFApuesta en juego: &#00f5ff%apuesta%",
                "&#E6CCFFUsa &#55ff55/war accept &#E6CCFFpara ir al campo de batalla.",
                "&#ff00ff&m=================================="
        );
    ...
    public static class AyudaNode {
        // 🌟 FIX: Migración a colores unificados
        @Setting("comando-war") private List<String> comandoWar = List.of(
                "&#ff00ff&m==================================",
                "&#00f5ff<bold>SISTEMA DE GUERRA</bold>",
                "&#E6CCFF» &#e6e600/war challenge <tag> <apuesta>",
                "&#E6CCFF» &#55ff55/war accept",
                "&#ff00ff&m=================================="
        );
