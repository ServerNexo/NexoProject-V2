package me.aeroxis.war.listeners;
...
/**
 * ⚔️ AeroxisWar - Listener Principal de Combate (Arquitectura Enterprise)
...
public class WarListener implements Listener {
    ...
    public void onWarCombat(EntityDamageByEntityEvent event) {
        if (event.getEntity() instanceof Player victima && event.getDamager() instanceof Player atacante) {
            ...
            AeroxisUser uVictima = userManager.getUserOrNull(victima.getUniqueId());
            AeroxisUser uAtacante = userManager.getUserOrNull(atacante.getUniqueId());
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        AeroxisUser uVictima = userManager.getUserOrNull(victima.getUniqueId());
        AeroxisUser uAsesino = userManager.getUserOrNull(asesino.getUniqueId());
