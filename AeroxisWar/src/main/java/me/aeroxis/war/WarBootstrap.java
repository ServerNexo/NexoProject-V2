...
import me.aeroxis.war.commands.ComandoWar;
import me.aeroxis.war.listeners.WarCrossplayListener;
import me.aeroxis.war.listeners.WarListener;
...
/**
 * 🏛️ AeroxisWar - Orquestador Enterprise
...
public class WarBootstrap {
    ...
    @Inject
    public WarBootstrap(AeroxisWar plugin, Injector injector, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
    ...
    public void startServices() {
        plugin.getLogger().info("⚡ Arrancando Arquitectura AeroxisWar Enterprise");

        registerEvents();
        registerCommands();

        plugin.getLogger().info("⚔️ AeroxisWar activado e inyectado con éxito.");
    }

    public void stopServices() {
        plugin.getLogger().info("⚔️ AeroxisWar apagado.");
    }
