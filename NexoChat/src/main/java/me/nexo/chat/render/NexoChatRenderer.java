...
@Singleton
public class NexoChatRenderer implements ChatRenderer {

    private final NexoChatPlugin plugin;
    private final NexoChatManager chatManager;
    private final NexoProfileCardFactory profileCardFactory;
    private final NexoAPI nexoApi;
    private final MiniMessage mm = MiniMessage.miniMessage();

    @Inject
    public NexoChatRenderer(NexoChatPlugin plugin, NexoChatManager chatManager, NexoProfileCardFactory profileCardFactory, NexoAPI nexoApi) {
        this.plugin = plugin;
    ...
    public @NotNull Component render(@NotNull Player source, @NotNull Component sourceDisplayName, @NotNull Component message, @NotNull Audience viewer) {
        NexoUser user = nexoApi.getUserLocal(source.getUniqueId());
