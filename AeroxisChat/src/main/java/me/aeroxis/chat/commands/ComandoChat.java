...
import me.aeroxis.chat.menu.TagsMenu;
 ...
 */
@Singleton
@Command({"chat", "aeroxis"}) // 🌟 FIX: Cambiado el prefijo 'nexo' a 'aeroxis'
public class ComandoChat {

    private final AeroxisChatManager chatManager;
    private final AeroxisChatDatabase chatDatabase;
    private final CrossplayUtils crossplayUtils;

    @Inject
    public ComandoChat(AeroxisChatManager chatManager, AeroxisChatDatabase chatDatabase, CrossplayUtils crossplayUtils) {
    ...
    @CommandPermission("aeroxischat.admin") // 🌟 FIX: Cambiado el permiso
    public void giveTagToPlayer(Player admin, Player target, String tagId) {
        var config = Bukkit.getPluginManager().getPlugin("AeroxisChat").getConfig(); // 🌟 FIX: Cambiado de NexoChat a AeroxisChat
    ...
    @CommandPermission("aeroxischat.nick") // 🌟 FIX: Cambiado el permiso
