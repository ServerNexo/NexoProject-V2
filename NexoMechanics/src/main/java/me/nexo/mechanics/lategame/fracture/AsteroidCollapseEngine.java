...
public class AsteroidCollapseEngine {
    ...
    @Inject
    public AsteroidCollapseEngine(NexoMechanics plugin, NexoPasterService pasterService) {
        this.plugin = plugin;
    ...
    private void executeAnnihilation(Location center, int radius) {
        ...
        Bukkit.getAsyncScheduler().runNow(plugin, task -> {
            ...
            NexoSchematic voidSchematic = new NexoSchematic("void_wipe", diameter, diameter, diameter, airBlocks);
