package me.nexo.mechanics.lategame.yggdrasil;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.nexo.items.api.lategame.LateGameArmorStats; // 🌟 IMPORTADO DE NEXOITEMS
import me.nexo.items.api.lategame.LateGameStatsCache; // 🌟 IMPORTADO DE NEXOITEMS
...
public class WindPhysicsEngine {
    ...
    @Inject
    public WindPhysicsEngine(NexoMechanics plugin) {
        this.plugin = plugin;
        startWindTask();
    }
