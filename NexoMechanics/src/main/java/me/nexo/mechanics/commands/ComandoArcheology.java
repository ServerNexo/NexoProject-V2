...
import me.nexo.mechanics.NexoMechanics; // 🌟 IMPORT AÑADIDO
...
public class ComandoArcheology {
    ...
    private final NexoMechanics plugin; // 🌟 VARIABLE AÑADIDA

    @Inject
    public ComandoArcheology(ArcheologyManager archeologyManager, NexoMechanics plugin) {
