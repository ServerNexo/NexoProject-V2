...
/**
 * ⚙️ Comando Administrativo Principal de NexoMechanics
 */
...
public class ComandoMechanics {
    ...
    @Inject
    public ComandoMechanics(NexoMechanics plugin, GatheringConfigLoader gatheringConfigLoader) {
        this.plugin = plugin;
    ...
    public void reload(CommandSender sender) {
        ...
        sender.sendMessage(mm.deserialize("<green>⚙️ Configuración de NexoMechanics y zonas de recolección recargadas exitosamente.</green>"));
    }
}