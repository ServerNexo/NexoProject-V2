package me.nexo.mechanics.gathering.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.nexo.mechanics.NexoMechanics;
import me.nexo.mechanics.gathering.data.Profession;
import me.nexo.mechanics.gathering.world.GatheringZone;
...
public class GatheringConfigLoader {
    ...
    @Inject
    public GatheringConfigLoader(NexoMechanics plugin, ZoneManager zoneManager) {
        this.plugin = plugin;
