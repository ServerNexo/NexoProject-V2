package me.nexo.core.events.types;
...
import me.nexo.core.events.NexoEvent;
 ...
 */
public class BossInvasionEvent implements NexoEvent {

    private final NexoCore plugin;
    private final CrossplayUtils crossplayUtils;
    private final MobVisualManager visualManager;
    private final NexoBossRegistry bossRegistry; // 🌟 NUEVA DEPENDENCIA
    ...
    @Inject
    public BossInvasionEvent(NexoCore plugin, CrossplayUtils crossplayUtils, MobVisualManager visualManager, NexoBossRegistry bossRegistry) {
        this.plugin = plugin;
