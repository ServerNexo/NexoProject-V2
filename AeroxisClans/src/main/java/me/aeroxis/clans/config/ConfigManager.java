package me.aeroxis.clans.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.clans.AeroxisClans;
import me.aeroxis.clans.config.nodes.ClansMessagesConfig;
...
/**
 * 👥 AeroxisClans - Gestor de Configuración Tipado (Arquitectura Enterprise)
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisClans plugin) {
        this.plugin = plugin;
        loadMessages();
    }
    ...
    public void loadMessages() {
        ...
        try {
            ...
            if (this.messages == null) {
                plugin.getLogger().warning("⚠️ El archivo messages.yml de AeroxisClans parece estar vacío. Usando valores por defecto.");
