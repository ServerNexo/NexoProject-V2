...
/**
 * 👥 AeroxisClans - Motor de Fuego Aliado (Arquitectura Enterprise)
...
public class ClanDamageListener implements Listener {
    ...
    // 💉 PILAR 1: Inyección Directa de Managers (Cero saltos estáticos hacia AeroxisCore)
    @Inject
    ...
    public void onPlayerDamage(EntityDamageByEntityEvent event) {
        ...
        AeroxisUser userAttacker = userManager.getUserOrNull(attacker.getUniqueId());
        AeroxisUser userVictim = userManager.getUserOrNull(victim.getUniqueId());
