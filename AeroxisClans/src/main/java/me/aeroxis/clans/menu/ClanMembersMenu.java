...
/**
 * 👥 AeroxisClans - Menú de Miembros (Arquitectura Enterprise Java 21)
 * Rendimiento: Cero Lag I/O, PlayerProfile Nativo, Folia Sync y Dependencias Inyectadas.
 */
public class ClanMembersMenu extends AeroxisMenu {

    private final AeroxisClans plugin;
    private final AeroxisClan clan;
    ...
    public ClanMembersMenu(Player player, AeroxisClans plugin, AeroxisClan clan, AeroxisUser user,
        ...
        /* 💡 NOTA: Si tu clase AeroxisMenu.java original no tiene CrossplayUtils en su
           constructor, debes ir a AeroxisCore y añadirlo:
           `public AeroxisMenu(Player player, CrossplayUtils crossplayUtils) { ... }` */
