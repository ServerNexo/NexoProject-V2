package me.aeroxis.islas.instances;
...
public class IslandSlimeManager {
    ...
    @Inject
    public IslandSlimeManager(AeroxisIslas plugin, AeroxisPasterService pasterService) {
        this.plugin = plugin;
    ...
    public void upgradeIslandBorders(IslandProfile profile, World islandWorld) {
        CompletableFuture.runAsync(() -> {
            ...
            // 🌟 FIX: Usamos AeroxisSchematic en lugar del String (Aquí creamos un dummy vacío para compilar)
            ...
            AeroxisSchematic ringSchematic = new AeroxisSchematic("island_ring_upgrade_tier_" + currentBorderTier, 0, 0, 0, emptyData);
