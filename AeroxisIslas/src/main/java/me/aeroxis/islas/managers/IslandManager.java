...
import me.aeroxis.islas.instances.IslandSlimeManager;
...
public class IslandManager {
    ...
    @Inject
    public IslandManager(AeroxisIslas plugin, IslandDatabase db, IslandSlimeManager slimeManager) {
        this.plugin = plugin;
        this.db = db;
    ...
    public AeroxisIslas getPlugin() { return plugin; }
}