...
/**
 * ⚙️ AeroxisIslas - Panel de Configuración (Arquitectura Enterprise)
 * Rendimiento: Modificaciones en Tiempo Real, Guardado Asíncrono y Manipulación Instanciada (ASP).
 */
public class IslandSettingsMenu extends AeroxisMenu {

    private final AeroxisIslas plugin;
    private final IslandManager islandManager;
    private final IslandProfile profile;

    public IslandSettingsMenu(Player player, CrossplayUtils crossplayUtils, AeroxisIslas plugin, IslandManager islandManager, IslandProfile profile) {
