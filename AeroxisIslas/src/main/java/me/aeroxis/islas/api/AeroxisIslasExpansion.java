...
public class AeroxisIslasExpansion extends PlaceholderExpansion {

    private final AeroxisIslas plugin;
    private final IslandManager islandManager;
    private final IslandLevelEngine levelEngine;

    public AeroxisIslasExpansion(AeroxisIslas plugin, IslandManager islandManager, IslandLevelEngine levelEngine) {
        this.plugin = plugin;
