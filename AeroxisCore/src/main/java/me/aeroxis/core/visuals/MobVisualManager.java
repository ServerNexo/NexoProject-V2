package me.aeroxis.core.visuals;
...
/**
 * 👁️ AeroxisCore - Motor de Tiers Visuales para Mobs Custom (Arquitectura Enterprise)
...
public class MobVisualManager implements Listener {
    ...
    @Inject
    public MobVisualManager(AeroxisCore plugin, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
