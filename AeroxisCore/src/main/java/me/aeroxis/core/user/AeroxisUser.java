...
import me.aeroxis.core.AeroxisCosmeticUnlockEvent;
...
public class AeroxisUser {
    ...
    private final AtomicInteger aeroxisNivel;
    private final AtomicInteger aeroxisXp;
    ...
    public AeroxisUser(UUID uuid, String nombre, int nNivel, int nXp, int cNivel, int cXp, int mNivel, int mXp, int aNivel, int aXp, UUID clanId, String clanRole) {
        this.uuid = uuid;
        this.nombre = nombre;
        ...
        this.aeroxisNivel = new AtomicInteger(nNivel);
        this.aeroxisXp = new AtomicInteger(nXp);
    ...
    public int getAeroxisNivel() { return aeroxisNivel.get(); }
    public int getAeroxisXp() { return aeroxisXp.get(); }
    ...
    // Setters Seguros
    public void setAeroxisNivel(int valor) { this.aeroxisNivel.set(valor); }
    public void addAeroxisXp(int cantidad) { this.aeroxisXp.addAndGet(cantidad); }
    public void setAeroxisXp(int valor) { this.aeroxisXp.set(valor); }
     ...
     * Dispara el evento AeroxisCosmeticUnlockEvent automáticamente.
     *
    ...
    public boolean unlockCosmetic(String cosmeticId) {
        if (this.unlockedCosmetics.add(cosmeticId)) {
            ...
            Bukkit.getPluginManager().callEvent(new AeroxisCosmeticUnlockEvent(this.uuid, cosmeticId));
            return true;
        }
        return false;
    }
