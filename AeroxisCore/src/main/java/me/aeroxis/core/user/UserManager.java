...
public class UserManager {
    ...
    private final Cache<UUID, AeroxisUser> usersCache;
     ...
     */
    public void addUserToCache(AeroxisUser user) {
        if (user != null) {
     ...
     */
    public Optional<AeroxisUser> getUser(UUID uuid) {
     ...
     * @return El AeroxisUser o null si no se encuentra en memoria.
     */
    public AeroxisUser getUserOrNull(UUID uuid) {
     ...
     * Esto soluciona los errores de compilación en NexoChat, ComandoAeroxis y CosmeticsMenu.
     */
    public void saveUserAsync(AeroxisUser user) {
        if (user != null) {
