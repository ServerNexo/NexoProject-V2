...
public class UserRepository {
    ...
    public CompletableFuture<AeroxisUser> fetchOrCreateUser(UUID uuid, String name) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            try (var conn = db.getConnection();
                ...
                try (var psInsert = conn.prepareStatement(insertSQL)) {
                    ...
                    return new AeroxisUser(uuid, name, 1, 0, 1, 0, 1, 0, 1, 0, null, "NONE");
                }
    ...
    public CompletableFuture<Void> saveBlessings(AeroxisUser user) {
