package me.aeroxis.core.crossplay;
...
public class CrossplayUtils {
    ...
    @Inject
    public CrossplayUtils(AeroxisColor aeroxisColor) {
    ...
    public Component parseCrossplay(Player player, String rawMessage) {
        ...
        // Uso de la instancia inyectada de AeroxisColor
        return aeroxisColor.parse(rawMessage);
    }
