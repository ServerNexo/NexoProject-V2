 ...
 * Arquitectura Enterprise: Hereda dependencias limpias de AeroxisMenu.
 */
public class HubMenu extends AeroxisMenu {

    private final AeroxisCore plugin;

    // 💉 PILAR 1: Constructor alineado con la base inyectable
    public HubMenu(Player player, AeroxisCore plugin, CrossplayUtils crossplayUtils) {
