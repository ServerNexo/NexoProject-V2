...
/**
 * 💰 AeroxisEconomy - Listener de Cuentas Bancarias (Arquitectura Enterprise Java 21)
...
public class EconomyListener implements Listener {
    ...
    @Inject
    public EconomyListener(AeroxisEconomy plugin, EconomyManager economyManager) {
        this.plugin = plugin;
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        economyManager.getAccountAsync(playerId, AeroxisAccount.AccountType.PLAYER).thenAccept(account -> {
            if (account != null) {
