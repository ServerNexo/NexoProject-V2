...
/**
 * 💰 AeroxisEconomy - Listener de Chat para Órdenes del Bazar (Arquitectura Enterprise Java 21)
...
public class BazaarChatListener implements Listener {
    ...
    @Inject
    public BazaarChatListener(AeroxisEconomy plugin, BazaarManager bazaarManager, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
