package me.aeroxis.economy.bazar;
...
/**
 * 💰 AeroxisEconomy - Menú de Navegación del Bazar (Arquitectura Enterprise Java 21)
 * Rendimiento: Folia Region Scheduler, Virtual Threads Handover, editMeta y Dependencias Transitivas.
 */
public class BazaarMenu extends AeroxisMenu {
    ...
    public BazaarMenu(Player player, AeroxisEconomy plugin, BazaarManager bazaarManager, ConfigManager configManager, CrossplayUtils crossplayUtils) {
        this(player, plugin, bazaarManager, configManager, crossplayUtils, MenuType.MAIN, "", "");
    }

    public BazaarMenu(Player player, AeroxisEconomy plugin, BazaarManager bazaarManager, ConfigManager configManager, CrossplayUtils crossplayUtils, String category) {
        this(player, plugin, bazaarManager, configManager, crossplayUtils, MenuType.CATEGORY, category, "");
    }

    public BazaarMenu(Player player, AeroxisEconomy plugin, BazaarManager bazaarManager, ConfigManager configManager, CrossplayUtils crossplayUtils, String category, String itemId) {
        this(player, plugin, bazaarManager, configManager, crossplayUtils, MenuType.ITEM_OPTIONS, category, itemId);
    }

    private BazaarMenu(Player player, AeroxisEconomy plugin, BazaarManager bazaarManager, ConfigManager configManager, CrossplayUtils crossplayUtils, MenuType type, String category, String selectedItem) {
