...
/**
 * 💰 AeroxisEconomy - Menú de Órdenes Propias (Arquitectura Enterprise Java 21)
 * Rendimiento: Virtual Thread Data Fetching, Folia Sync y PDC Tipado.
 */
public class BazaarMyOrdersMenu extends AeroxisMenu {
    ...
    public BazaarMyOrdersMenu(Player player, AeroxisEconomy plugin, BazaarManager bazaarManager, ConfigManager configManager, CrossplayUtils crossplayUtils) {
