package me.aeroxis.economy.commands;
...
/**
 * 💰 AeroxisEconomy - Comando Principal de Economía (Arquitectura Enterprise Java 21)
...
public class ComandoEco extends Command {
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String commandLabel, @NotNull String[] args) {
        ...
        if (args.length == 0) {
            ...
            var accOpt = economyManager.getCachedAccount(player.getUniqueId(), AeroxisAccount.AccountType.PLAYER);
        ...
        if (args[0].equalsIgnoreCase("give")) {
            if (!sender.hasPermission("aeroxiseconomy.admin")) {
            ...
            try {
                currency = AeroxisAccount.Currency.valueOf(args[2].toUpperCase());
            ...
            economyManager.updateBalanceAsync(targetId, AeroxisAccount.AccountType.PLAYER, currency, amount, true).thenAccept(success -> {
                ...
                if (success) {
                    ...
                    if (isPlayerSender) {
                        ...
                        sender.sendMessage("§a[AeroxisEconomy] Has emitido " + amount.toPlainString() + " " + currency.name() + " a la cuenta de " + targetName + ".");
                    }
                    ...
                    if (isPlayerSender) {
                        ...
                        sender.sendMessage("§c[AeroxisEconomy] Error crítico en la transacción atómica.");
                    }
                }
            });
            return true;
