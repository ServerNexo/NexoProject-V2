...
import me.aeroxis.economy.bazar.BazaarMenu;
...
/**
 * 💰 AeroxisEconomy - Comando del Bazar (Arquitectura Enterprise Java 21)
...
public class ComandoBazar extends Command {
    ...
    @Inject
    public ComandoBazar(AeroxisEconomy plugin, BazaarManager bazaarManager, ConfigManager configManager, CrossplayUtils crossplayUtils) {
        super("bazar");
