...
import me.aeroxis.economy.blackmarket.BlackMarketMenu;
...
/**
 * 💰 AeroxisEconomy - Comando del Mercado Negro (Arquitectura Enterprise Java 21)
 * Rendimiento: CommandMap Nativo, Console Safety y Sinergia Inyectada.
 */
@Singleton
public class ComandoMercadoNegro extends Command {

    // 🌟 DEPENDENCIAS PROPAGADAS (Desde AeroxisEconomy y AeroxisCore)
    ...
    @Inject
    public ComandoMercadoNegro(AeroxisEconomy plugin, BlackMarketManager blackMarketManager, EconomyManager ecoManager, CrossplayUtils crossplayUtils, UserManager userManager) {
        super("mercadonegro");
