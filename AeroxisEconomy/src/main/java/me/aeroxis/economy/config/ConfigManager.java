package me.aeroxis.economy.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.economy.AeroxisEconomy;
import me.aeroxis.economy.config.nodes.EconomyMessagesConfig;
...
/**
 * 💰 AeroxisEconomy - Gestor de Configuración Tipado (Arquitectura Enterprise Java 21)
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisEconomy plugin) {
        this.plugin = plugin;
        loadMessages();
    }
