...
import me.aeroxis.economy.AeroxisEconomy; // 🌟 IMPORTANTE: Importamos la clase principal
...
/**
 * 💰 AeroxisEconomy - Manager de Intercambios (Arquitectura Enterprise)
...
public class TradeManager {
    ...
    private final AeroxisEconomy plugin; // 🌟 FIX: Añadimos la instancia del plugin
    ...
    @Inject
    public TradeManager(AeroxisEconomy plugin, EconomyManager economyManager, CrossplayUtils crossplayUtils) {
