package me.aeroxis.pvp.commands;
...
import me.aeroxis.pvp.menus.BlessingMenu;
...
/**
 * 🏛️ AeroxisPvP - Comando Templo (Arquitectura Enterprise)
...
public class ComandoTemplo {
    ...
    public ComandoTemplo(ConfigManager configManager, UserRepository userRepository, UserManager userManager,
                         AeroxisPvP plugin, CrossplayUtils crossplayUtils, EconomyManager economyManager) {
