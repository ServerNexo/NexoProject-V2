package me.aeroxis.pvp.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.pvp.AeroxisPvP;
import me.aeroxis.pvp.config.nodes.PvPMessagesConfig;
...
/**
 * 🏛️ Aeroxis Network (PvP Module) - Config Manager Purificado
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisPvP plugin) {
        this.plugin = plugin;
    ...
    private void loadConfigurate() {
        ...
        try {
            ...
            if (this.messages == null) {
                plugin.getLogger().warning("⚠️ El archivo messages.yml de AeroxisPvP parece estar vacío. Usando valores por defecto.");
                this.messages = new PvPMessagesConfig();
            }
        } catch (Exception e) {
            plugin.getLogger().severe("❌ Error crítico al cargar messages.yml en AeroxisPvP: " + e.getMessage());
        }
    }
