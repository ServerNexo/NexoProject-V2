...
import me.aeroxis.colecciones.menu.ColeccionesMenu;
...
/**
 * 📚 AeroxisColecciones - Comando Principal y Autocompletado (Arquitectura Enterprise)
...
public class ComandoColecciones extends Command {
    ...
    @Inject
    public ComandoColecciones(AeroxisColecciones plugin, ColeccionesConfig config,
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String commandLabel, @NotNull String[] args) {
        ...
        if (!(sender instanceof Player player)) {
            if (args.length == 1 && args[0].equalsIgnoreCase("reload")) {
                ...
                sender.sendMessage("[AeroxisColecciones] Archivos recargados exitosamente en la memoria RAM.");
            } else {
