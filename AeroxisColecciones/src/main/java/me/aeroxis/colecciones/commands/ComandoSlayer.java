package me.aeroxis.colecciones.commands;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.colecciones.AeroxisColecciones;
import me.aeroxis.colecciones.menu.SlayerMenu;
import me.aeroxis.colecciones.slayers.SlayerManager;
import me.aeroxis.core.crossplay.CrossplayUtils;
import me.aeroxis.economy.core.EconomyManager; // 🌟 NUEVO IMPORT INYECTADO
...
/**
 * 📚 AeroxisColecciones - Comando de Cacería Slayer (Arquitectura Enterprise)
...
public class ComandoSlayer extends Command {
    ...
    @Inject
    public ComandoSlayer(AeroxisColecciones plugin, SlayerManager slayerManager, CrossplayUtils crossplayUtils, EconomyManager economyManager) {
