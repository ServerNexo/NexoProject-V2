package me.aeroxis.colecciones.api;
...
/**
 * 📚 AeroxisColecciones - Expansión de PlaceholderAPI (Arquitectura Enterprise)
...
public class ColeccionesExpansion extends PlaceholderExpansion {
    ...
    @Inject
    public ColeccionesExpansion(AeroxisColecciones plugin, CollectionManager manager) {
        this.plugin = plugin;
