package me.aeroxis.colecciones.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.colecciones.AeroxisColecciones;
import me.aeroxis.colecciones.config.nodes.ColeccionesMessagesConfig;
...
/**
 * 📚 AeroxisColecciones - Gestor de Configuración Tipado (Arquitectura Enterprise)
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisColecciones plugin) {
        this.plugin = plugin;
        loadMessages();
    }
    ...
    public void loadMessages() {
        ...
        try {
            ...
            if (this.messages == null) {
                plugin.getLogger().warning("⚠️ El archivo messages.yml de AeroxisColecciones parece estar vacío. Usando valores por defecto.");
