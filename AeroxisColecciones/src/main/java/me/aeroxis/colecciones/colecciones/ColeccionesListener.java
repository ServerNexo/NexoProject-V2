...
/**
 * 📚 AeroxisColecciones - Escucha de Eventos de Farmeo (Arquitectura Enterprise)
...
public class ColeccionesListener implements Listener {
    ...
    @Inject
    public ColeccionesListener(AeroxisColecciones plugin, CollectionManager manager, DatabaseManager db) {
        this.plugin = plugin;
