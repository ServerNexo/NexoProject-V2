...
import me.nexo.tools.managers.LocationManager;
import me.nexo.tools.managers.TeleportManager;
...
public class LocationCommands {
    ...
    @Inject
    public LocationCommands(NexoTools plugin, LocationManager locManager, TeleportManager tpManager, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
