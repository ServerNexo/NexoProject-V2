package me.nexo.factories.api;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.nexo.core.api.NexoFactoriesAPI;
import me.nexo.core.database.DatabaseManager; // 🌟 IMPORTANTE
...
/**
 * 🔌 NexoFactories - Implementación de la API de Enrutamiento
 * Rendimiento: Item Sorter O(N), Soporte Folia y Enrutamiento a la Nube (Silos VIP).
 */
@Singleton
public class NexoFactoriesAPIImpl implements NexoFactoriesAPI {
    ...
    @Inject
    public NexoFactoriesAPIImpl(NexoFactories plugin, FactoryManager factoryManager, FactoryVisualEngine visualEngine, DatabaseManager databaseManager) {
        this.plugin = plugin;
