...
import me.aeroxis.minions.menu.MinionMenu;
...
/**
 * 🤖 AeroxisMinions - Listener de Interacción (Arquitectura Enterprise)
...
public class MinionInteractListener implements Listener {
    ...
    @Inject
    public MinionInteractListener(AeroxisMinions plugin, MinionManager minionManager, ConfigManager configManager,
