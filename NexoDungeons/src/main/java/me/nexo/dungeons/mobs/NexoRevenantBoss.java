package me.nexo.dungeons.mobs;

import me.nexo.core.bosses.NexoGlobalBoss;
...
/**
 * 💀 El Renacido (NexoRevenantBoss) - Encuentro Nivel Raid (AAA)
 * Inteligencia: Aggro por DPS, Raycasting, Saltos Parabólicos, Cleave y BossBar.
 */
public class NexoRevenantBoss extends NexoGlobalBoss {
    ...
    public NexoRevenantBoss(JavaPlugin plugin, CrossplayUtils crossplayUtils) {
