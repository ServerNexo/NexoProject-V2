package me.aeroxis.mechanics.minigames;
...
import me.aeroxis.protections.core.ClaimAction;
...
/**
 * ⛏️ AeroxisMechanics - Minijuego de Minería RPG (Arquitectura Enterprise Java 21)
...
public class MiningMinigameManager implements Listener {
    ...
    @Inject
    public MiningMinigameManager(AeroxisMechanics plugin, ConfigManager configManager,
    ...
    public void alPicar(BlockBreakEvent event) {
        ...
        if (claimManager != null) {
            ...
            if (stone != null && !stone.hasPermission(id, ClaimAction.BREAK)) {
        ...
        if (veta != null) {
            if (b.getLocation().equals(veta.loc())) {
                ...
                if (economyManager != null) {
                    economyManager.updateBalanceAsync(p.getUniqueId(), AeroxisAccount.AccountType.PLAYER, AeroxisAccount.Currency.COINS, recompensaMonedas, true);
                }
