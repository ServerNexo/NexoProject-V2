package me.aeroxis.mechanics.managers;
...
/**
 * 🕵️ AeroxisMechanics - Gestor de Contrabando y Leviatanes (Arquitectura Enterprise)
...
public class ContrabandManager {
    ...
    @Inject
    public ContrabandManager(AeroxisMechanics plugin) {
        this.plugin = plugin;
