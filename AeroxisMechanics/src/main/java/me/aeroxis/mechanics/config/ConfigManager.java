package me.aeroxis.mechanics.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.mechanics.AeroxisMechanics;
import me.aeroxis.mechanics.config.nodes.MechanicsMessagesConfig;
...
/**
 * ⚙️ AeroxisMechanics - Config Manager Purificado (Arquitectura Enterprise)
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisMechanics plugin) {
        this.plugin = plugin;
    ...
    private void loadConfigurate() {
        ...
        try {
            ...
            plugin.getLogger().severe("❌ Error al cargar messages.yml en AeroxisMechanics: " + e.getMessage());
