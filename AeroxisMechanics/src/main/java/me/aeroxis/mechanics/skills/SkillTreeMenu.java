package me.aeroxis.mechanics.skills;
...
/**
 * ⚙️ AeroxisMechanics - Menú de Árbol de Habilidades (Arquitectura Enterprise)
 * Nota: Los permisos se gestionan a través de una sinergia entre UserManager y Attachments.
 */
public class SkillTreeMenu extends AeroxisMenu {
