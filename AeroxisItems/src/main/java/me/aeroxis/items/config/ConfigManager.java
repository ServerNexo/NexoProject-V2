package me.aeroxis.items.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.items.AeroxisItems;
import me.aeroxis.items.config.nodes.ItemsMessagesConfig;
...
/**
 * 🎒 AeroxisItems - Config Manager Purificado (Arquitectura Enterprise Java 21)
...
public class ConfigManager {
    ...
    @Inject
    public ConfigManager(AeroxisItems plugin) {
        this.plugin = plugin;
    ...
    private void loadConfigurate() {
        ...
        try {
            ...
            plugin.getLogger().severe("❌ Error al cargar messages.yml en AeroxisItems: " + e.getMessage());
        }
    }
