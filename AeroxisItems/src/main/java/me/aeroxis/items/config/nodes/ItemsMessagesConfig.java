package me.aeroxis.items.config.nodes;
...
/**
 * 🎒 AeroxisItems - Configurate Type-Safe Node (Arquitectura Enterprise Java 21)
 * Estructura de mapeo inmutable para messages.yml
 */
@ConfigSerializable
public class ItemsMessagesConfig {
    ...
    public static class EventosNode {
        ...
        @Setting private HabilidadesNode habilidades = new HabilidadesNode(); 
