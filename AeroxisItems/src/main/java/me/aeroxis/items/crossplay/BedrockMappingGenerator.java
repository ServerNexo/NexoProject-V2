package me.aeroxis.items.crossplay;
...
/**
 * 🎒 AeroxisItems - Generador de Mapeos GeyserMC (Arquitectura Enterprise Java 21)
...
public class BedrockMappingGenerator {
    ...
    @Inject
    public BedrockMappingGenerator(AeroxisItems plugin, FileManager fileManager) {
        this.plugin = plugin;
    ...
    private void guardarArchivoJson(JsonObject root) {
        // Guardamos el archivo en la carpeta de AeroxisItems.
