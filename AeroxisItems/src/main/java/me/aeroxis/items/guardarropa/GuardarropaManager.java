package me.aeroxis.items.guardarropa;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.core.crossplay.CrossplayUtils;
import me.aeroxis.core.database.DatabaseManager; // Asumido desde AeroxisCore
...
/**
 * 🎒 AeroxisItems - Manager del Sistema de Guardarropa (Arquitectura Enterprise Java 21)
...
public class GuardarropaManager {
    ...
    @Inject
    public GuardarropaManager(AeroxisItems plugin, DatabaseManager dbManager, CrossplayUtils crossplayUtils, Base64Util base64Util) {
        this.plugin = plugin;
