package me.aeroxis.items.managers;
...
/**
 * ⚔️ AeroxisItems - Gestor de Ítems (Arquitectura Enterprise Java 21)
...
public class ItemManager {
    ...
    @Inject
    public ItemManager(AeroxisItems plugin, FileManager fileManager, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
