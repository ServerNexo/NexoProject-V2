...
/**
 * 🎒 AeroxisItems - Menú de Forja Cénit (Arquitectura Enterprise Java 21)
 ...
 */
public class UpgradeMenu extends AeroxisMenu {
    ...
    public UpgradeMenu(Player player, AeroxisItems plugin, ItemManager itemManager, CrossplayUtils crossplayUtils) {
    ...
    public String getMenuName() {
        // 🌟 FIX: Retornamos el String en crudo, AeroxisMenu (Paper API) lo procesará nativamente.
