package me.aeroxis.items.commands;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.core.crossplay.CrossplayUtils;
import me.aeroxis.items.AeroxisItems;
import me.aeroxis.items.estaciones.UpgradeMenu;
...
/**
 * 🎒 AeroxisItems - Comando de Forja/Upgrade (Arquitectura Enterprise Java 21)
...
public class ComandoUpgrade extends Command {
    ...
    @Inject
    public ComandoUpgrade(AeroxisItems plugin, ItemManager itemManager, CrossplayUtils crossplayUtils) {
        super("forja");
