...
import me.aeroxis.core.database.DatabaseManager; // Asumido desde el Core
...
/**
 * 🎒 AeroxisItems - Manager Central de Accesorios (Arquitectura Enterprise Java 21)
...
public class AccesoriosManager {
    ...
    @Inject
    public AccesoriosManager(AeroxisItems plugin, DatabaseManager dbManager, CrossplayUtils crossplayUtils, Base64Util base64Util) {
        this.plugin = plugin;
