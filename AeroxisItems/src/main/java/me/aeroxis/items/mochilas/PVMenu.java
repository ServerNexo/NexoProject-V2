package me.aeroxis.items.mochilas;

import me.aeroxis.core.hub.HubMenu;
...
/**
 * 🎒 AeroxisItems - Menú de Bóvedas del Vacío / Player Vaults (Arquitectura Enterprise Java 21)
 ...
 */
public class PVMenu extends AeroxisMenu {

    // 🌟 DEPENDENCIAS PROPAGADAS
    private final AeroxisItems plugin;
    private final AeroxisCore corePlugin;
    ...
    public PVMenu(Player player, AeroxisItems plugin, AeroxisCore corePlugin, CrossplayUtils crossplayUtils) {
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        // Si dio clic en Volver
            ...
            player.getScheduler().runDelayed(plugin, task -> {
                new HubMenu(player, corePlugin, crossplayUtils).open();
            }, null, 3L);
        }
    }
}