...
/**
 * 🎒 AeroxisItems - Comando Player Vaults (Arquitectura Enterprise Java 21)
...
public class ComandoPV extends Command {
    ...
    @Inject
    public ComandoPV(AeroxisItems plugin, AeroxisCore corePlugin, MochilaManager manager, CrossplayUtils crossplayUtils) {
        super("pv");
