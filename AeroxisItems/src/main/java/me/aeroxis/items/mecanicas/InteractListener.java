...
/**
 * 🎒 AeroxisItems - Gestor de Habilidades y Artefactos (Arquitectura Enterprise Java 21)
...
public class InteractListener implements Listener {
    ...
    @Inject
    public InteractListener(AeroxisItems plugin, FileManager fileManager, UserManager userManager, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
