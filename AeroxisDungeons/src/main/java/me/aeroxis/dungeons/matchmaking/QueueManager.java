package me.aeroxis.dungeons.matchmaking;
...
import me.aeroxis.dungeons.engine.AbyssScalingEngine; // 🌟 NUEVO IMPORT
...
/**
 * 🏰 AeroxisDungeons - Motor de Emparejamiento Adaptativo (Arquitectura ASP & Java 21+)
...
public final class QueueManager { // 🌟 FIX 1: Añadido 'final' para seguridad del constructor
    ...
    @Inject
    public QueueManager(AeroxisDungeons plugin, AeroxisDungeonFactory dungeonFactory,
