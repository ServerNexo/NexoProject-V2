...
/**
 * 🏰 AeroxisDungeons - Listener de Seguridad y Anti-Dupe (Arquitectura Enterprise)
...
public class DungeonSecurityListener implements Listener {
    ...
    @Inject
    public DungeonSecurityListener(AeroxisDungeons plugin, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
