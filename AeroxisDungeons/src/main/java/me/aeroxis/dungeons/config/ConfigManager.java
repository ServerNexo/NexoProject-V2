package me.aeroxis.dungeons.config;

import com.google.inject.Inject;
import com.google.inject.Singleton;
import me.aeroxis.dungeons.AeroxisDungeons;
import me.aeroxis.dungeons.config.nodes.DungeonsMessagesConfig;
...
/**
 * 🏰 AeroxisDungeons - Gestor de Configuración Tipado (Arquitectura Enterprise Java 21)
...
public final class ConfigManager { // 🌟 FIX: 'final' silencia el this-escape en Java 21
    ...
    @Inject
    public ConfigManager(AeroxisDungeons plugin) {
        this.plugin = plugin;
