package me.aeroxis.dungeons.menu;
...
/**
 * 🏰 AeroxisDungeons - Menú Principal de Mazmorras (Arquitectura Enterprise Java 21)
 * Rendimiento: editMeta O(1), Cero Instanciación de Llaves (GC Safe) e Inyección Transitiva.
 */
public class DungeonMenu extends AeroxisMenu {
