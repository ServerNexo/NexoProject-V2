...
/**
 * 🏰 AeroxisDungeons - Instancia de Arena de Oleadas (Arquitectura Enterprise Java 21)
...
public class WaveArena {
    ...
    public WaveArena(AeroxisDungeons plugin, String arenaId, Location spawnCenter, CrossplayUtils crossplayUtils) {
        this.plugin = plugin;
